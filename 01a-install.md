...
I have both version installed. I switch back and forth between them as some of the code I have written is using other libararies which are in python2 and some are in python3.
